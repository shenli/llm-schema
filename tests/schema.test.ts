...
defineSchema({
  ...
  summary: md({ optional: true, maxLength: 2000, note: 'markdown without h1 headings, max 2000 chars', allowedMarkdown: { bold: true, italic: true, lists: true, headers: true, links: false, images: false }, toolbar: ['bold', 'italic', 'bulletList', 'numberedList'], livePreview: true }),
  actionItems: array({
